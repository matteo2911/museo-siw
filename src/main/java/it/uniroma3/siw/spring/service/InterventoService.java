...
public class InterventoService {
	...
	@Transactional
	public List<Intervento> interventoPerTitoloAndDescrizione(LocalDate dataPrenotazione ) {
		return interventoRepository.findBydataPrenotazione( dataPrenotazione);
	}
	...
	public boolean alreadyExists(Intervento intervento) {
		List<Intervento> interventi = this.interventoRepository. findBydataPrenotazione(intervento.getDataPrenotazione());
