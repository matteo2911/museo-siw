...
public class TipologiaInterventoService {
	...
	@Transactional
	public List<TipologiaIntervento> collezionePerNomeAndCodice(String nome, String codice) {
		return tipologiaInterventoRepository.findByNomeOrCodice(nome, codice);
	}
	...
	public boolean alreadyExists(TipologiaIntervento tipologiaIntervento) {
		List<TipologiaIntervento> tipologiaInterventi = this.tipologiaInterventoRepository.findByNomeOrCodice(tipologiaIntervento.getNome(), tipologiaIntervento.getCodice());
