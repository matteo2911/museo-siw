...
public class TipologiaInterventoController {
    ...
    public String addTipologiaIntervento(Model model) {
    	...
    	model.addAttribute("clienti",tipologiaInterventoService.getClienteService().tutti());
    ...
    public String getTipologiaIntervento(Model model) {
    ...
    public String newCollezione(@ModelAttribute("tipologiaIntervento") TipologiaIntervento tipologiaIntervento, 
    ...
    @RequestMapping(value = "/admin/addInterventoTipologiaIntervento/{id}", method = RequestMethod.POST)
